namespace DijkstraAlgorithm
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            FillDistancesArray(distances, start);
            ...
            UseDijkstra(queue, end, distances, prev);
        ...
        private static void FillDistancesArray(int[] distances, int start)
        {
        ...
        private static void UseDijkstra(OrderedBag<int> queue, int end, int[] distances, int[] prev)
        {
            while (queue.Count > 0)
            {
