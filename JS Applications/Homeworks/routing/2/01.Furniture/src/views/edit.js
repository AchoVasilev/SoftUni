    ...
    <div class="row space-top">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input class="form-control ${errors.make ? errors.make : ''}" id="new-make" type="text" name="make" value=${item.make}>
            </div>
            <div class="form-group has-success">
                <label class="form-control-label" for="new-model">Model</label>
                <input class="form-control ${errors.model ? errors.model : ''}" id="new-model" type="text" name="model" value=${item.model}>
            </div>
            <div class="form-group has-danger">
                <label class="form-control-label" for="new-year">Year</label>
                <input class="form-control ${errors.year ? errors.year : ''}" id="new-year" type="number" name="year" value=${item.year}>
            </div>
            <div class="form-group">
                <label class="form-control-label" for="new-description">Description</label>
                <input class="form-control ${errors.description ? errors.description : ''}" id="new-description" type="text" name="description"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input class="form-control ${errors.price ? errors.price : ''}" id="new-price" type="number" name="price" value=${item.price}>
            </div>
            <div class="form-group">
                <label class="form-control-label" for="new-image">Image</label>
                <input class="form-control ${errors.img ? errors.img : ''}" id="new-image" type="text" name="img" value=${item.img}>
            </div>
            <div class="form-group">
