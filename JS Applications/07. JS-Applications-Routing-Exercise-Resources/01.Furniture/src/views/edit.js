...
export function editPage(context) {
    ...
    let itemPromise = getById(itemId);
    
    update(itemPromise);

    function update(itemPromise, errorMsg = null, error = {}) {
        context.render(editTemplate(loadItem(itemPromise, errorMsg, error)));
    }

    async function loadItem(itemPromise, errorMsg, error) {
